...
(custom-set-faces
 ...
 ;; If there is more than one, they won'twww work right.
...
(custom-set-variables
 ...
 '(package-selected-packages
        (quote
         (rainbow-mode swiper hideshow-org wakatime-mode ace-window projectile all-the-icons neotree gruvbox-theme sublime-themes smex ##))))
