...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  ...
  hi CursorLineNr   term=none cterm=none ctermfg=1    ctermbg=234
  ...
  hi Macro          term=none cterm=none ctermfg=1   ctermbg=none
  ...
  hi Number         term=none cterm=none ctermfg=1    ctermbg=none
  ...
  hi Structure      term=none cterm=none ctermfg=1  ctermbg=none
