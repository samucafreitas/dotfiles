...
if ( &t_Co >= 255 || $TERM =~? "256color" )
  ...
  hi Comment        term=none cterm=none ctermfg=245  ctermbg=236
  hi Conditional    term=none cterm=bold ctermfg=5  ctermbg=none
  hi Constant       term=none cterm=bold ctermfg=5  ctermbg=none
  hi Cursor         term=none cterm=bold ctermfg=232  ctermbg=109
  hi CursorLine     term=none cterm=none ctermfg=none ctermbg=238
  hi CursorLineNr   term=none cterm=bold ctermfg=5  ctermbg=240
  hi CursorColumn   term=none cterm=bold ctermfg=none ctermbg=238
  ...
  hi Number         term=none cterm=none ctermfg=5  ctermbg=none
  hi Operator       term=none cterm=bold ctermfg=5  ctermbg=none
  ...
  hi Repeat         term=none cterm=bold ctermfg=5  ctermbg=none
  ...
  hi Statement      term=none cterm=bold ctermfg=5  ctermbg=none
  ...
  hi Structure      term=none cterm=bold ctermfg=5  ctermbg=none
  ...
  hi Todo           term=none cterm=bold ctermfg=5  ctermbg=235
  hi Typedef        term=none cterm=bold ctermfg=253  ctermbg=none
  hi Type           term=none cterm=bold ctermfg=5  ctermbg=none
  hi Underlined     term=none cterm=bold ctermfg=188  ctermbg=none
  hi VertSplit      term=none cterm=none ctermfg=5  ctermbg=none
  hi VisualNOS      term=none cterm=bold ctermfg=5  ctermbg=none
