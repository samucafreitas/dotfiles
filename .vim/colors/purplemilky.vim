...
" Maintainer:   Sam Uel <samuelfreitas@linuxmail.org>
" Created:      24 dec 2018
" Last Change:  17 jan 2019
...
let g:colors_name="purplemilky"

if ( &t_Co >= 255 || $TERM =~? "256color" )
  hi Normal         term=none cterm=none ctermfg=256  ctermbg=none
  hi Boolean        term=none cterm=bold ctermfg=132  ctermbg=none
  hi Character      term=none cterm=none ctermfg=141  ctermbg=none
  hi Comment        term=none cterm=none ctermfg=131  ctermbg=none
  hi Conditional    term=none cterm=bold ctermfg=141  ctermbg=none
  hi Constant       term=none cterm=bold ctermfg=141  ctermbg=none
  hi Cursor         term=none cterm=bold ctermfg=232  ctermbg=109
  hi CursorLine     term=none cterm=none ctermfg=none ctermbg=233
  hi CursorLineNr   term=none cterm=bold ctermfg=141  ctermbg=233
  hi CursorColumn   term=none cterm=bold ctermfg=none ctermbg=233
  hi Debug          term=none cterm=bold ctermfg=181  ctermbg=none
  hi Define         term=none cterm=bold ctermfg=141   ctermbg=none
  ...
  hi DiffDelete     term=none cterm=bold ctermfg=25  ctermbg=237
  ...
  hi FoldColumn     term=none cterm=bold ctermfg=141   ctermbg=25
  hi Folded         term=none cterm=bold ctermfg=65   ctermbg=none
  hi Function       term=none cterm=bold ctermfg=141  ctermbg=none
  hi Identifier     term=none cterm=bold ctermfg=141  ctermbg=none
  hi IncSearch      term=none cterm=bold ctermfg=232  ctermbg=78
  hi Keyword        term=none cterm=bold ctermfg=141   ctermbg=none
  hi Label          term=none cterm=bold ctermfg=141  ctermbg=none
  hi LineNr         term=none cterm=none ctermfg=240  ctermbg=none
  hi MatchParen     term=none cterm=none ctermfg=0    ctermbg=141
  hi Macro          term=none cterm=bold ctermfg=141  ctermbg=none
  ...
  hi Operator       term=none cterm=bold ctermfg=141  ctermbg=none
  ...
  hi Repeat         term=none cterm=bold ctermfg=141  ctermbg=none
  ...
  hi Statement      term=none cterm=bold ctermfg=141  ctermbg=none
  hi StatusLine     term=none cterm=bold ctermfg=234  ctermbg=240
  hi StatusLineNC   term=none cterm=bold ctermfg=239  ctermbg=25
  hi StorageClass   term=none cterm=bold ctermfg=249  ctermbg=none
  hi String         term=none cterm=none ctermfg=204  ctermbg=none
  hi Structure      term=none cterm=bold ctermfg=141  ctermbg=none
  hi TabLine        term=none cterm=bold ctermfg=238  ctermbg=25
  hi TabLineFill    term=none cterm=bold ctermfg=238  ctermbg=25
  ...
  hi Todo           term=none cterm=bold ctermfg=141  ctermbg=235
  hi Typedef        term=none cterm=bold ctermfg=253  ctermbg=none
  hi Type           term=none cterm=bold ctermfg=141  ctermbg=none
  hi Underlined     term=none cterm=bold ctermfg=188  ctermbg=none
  hi VertSplit      term=none cterm=none ctermfg=141  ctermbg=none
  hi VisualNOS      term=none cterm=bold ctermfg=141  ctermbg=none
